...
function getModifier(modifiers: Modifiers, name: string) {
...
function CalendarDayButton({
  ...
  React.useEffect(() => {
    if (getModifier(modifiers, "focused")) {
      ref.current?.focus();
    }
  }, [modifiers]);

  const isSelected = getModifier(modifiers, "selected");
  const isRangeStart = getModifier(modifiers, "range_start");
  const isRangeEnd = getModifier(modifiers, "range_end");
  const isRangeMiddle = getModifier(modifiers, "range_middle");
