...
import { type EffectId, effects, presets, type Sound, samples, soundById } from "../lib/catalog";
...
export function NoteEditor(props: {
  ...
  return soundById(props.track.sound).kind === "sample" ? (
    <DrumEditor {...props} />
  ) : (
    <PianoRoll {...props} />
  );
  ...
  return (
    <div className="note-editor">
      ...
      <div className="editor-hint">
        <span>Click steps to build your groove.</span>
